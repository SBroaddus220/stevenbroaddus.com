...
def plot_combined():
    ...
    create_asymmetrical_wrap(fig, base_radius=0.115, top_radius=2.3, height=2.6, x_offset=0, y_offset=0, z_offset=0.6, color='pink', angular_adjustments=angular_adjustments)
